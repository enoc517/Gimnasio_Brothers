...
namespace Gimnasio_Brothers.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (!await _roleManager.RoleExistsAsync(Constantes.Admin))
                    {
                        ...
                        await _roleManager.CreateAsync(new IdentityRole(Constantes.Profesor));
                    ...
                    else if (rol == Constantes.Profesor)
                    {
                        await _userManager.AddToRoleAsync(user, Constantes.Profesor);
                    }
                    else if (rol == Constantes.Cliente)
                    {
